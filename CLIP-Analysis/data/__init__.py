...
def create_dataset(dataset, config, preprocess, min_scale=0.5):
    ...
    if dataset=='pretrain':
        ...
        train_dataset = vqa_dataset(preprocess, config['ann_root'], config['vqa_root'], config['vg_root'], 
                                    train_files = config['train_files'], split='train') 
        test_dataset = vqa_dataset(preprocess, config['ann_root'], config['vqa_root'], config['vg_root'], split='test')
